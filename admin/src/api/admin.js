...
export const getSystemReleases = (force = false) => request.get('/system/releases', { params: force ? { force: 'true' } : {} })
export const triggerSystemUpdate = (version) => request.post('/system/update', { version })
